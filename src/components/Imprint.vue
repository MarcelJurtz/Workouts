<template>
  <div class="imprint-container">
    ...
    <p>Marcel Jurtz Nussdorfer Straße 6 88662 Überlingen</p>
    <h2 id="kontakt-">Kontakt:</h2>
    <p>Telefon: 01775711065 E-Mail: marcel@mjurtz.com</p>
    <h2 id="verantwortlich-f-r-den-inhalt-nach-55-abs-2-rstv-">
      Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:
    </h2>
    <p>Marcel Jurtz</p>
    <h2 id="haftung-f-r-inhalte">Haftung für Inhalte</h2>
    <p>
    ...
    <h2 id="haftung-f-r-links">Haftung für Links</h2>
    <p>
